...
func serveOneHTTPConn(conn net.Conn, handler http.Handler) error {
	return serveOneHTTPConnWithTimeouts(
		conn,
		handler,
		defaultDownstreamReadHeaderTimeout,
		defaultDownstreamReadTimeout,
		defaultDownstreamIdleTimeout,
	)
}
...
func (p *Proxy) serveOneHTTPConn(conn net.Conn, handler http.Handler) error {
	return serveOneHTTPConnWithTimeouts(
		conn,
		handler,
		p.downstreamReadHeaderTimeout,
		p.downstreamReadTimeout,
		p.downstreamIdleTimeout,
	)
}

func serveOneHTTPConnWithTimeouts(conn net.Conn, handler http.Handler, readHeaderTimeout, readTimeout, idleTimeout time.Duration) error {
